...
import { useProduct } from "../contexts/product.context"; // Use ProductContext instead of service
...
const AddProduct = () => {
  ...
  const { addProduct } = useProduct(); // Use addProduct from context
      ...
      <div className="w-1/2 max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col">
            ...
            <label className="input input-bordered flex items-center gap-2 mb-4">
              <span className="w-full">Specifications</span>
              <textarea
                name="specifications"
                className="w-full text-sm"
